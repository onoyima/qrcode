...
function createBanner($link, $logoPath, $message) {
    ...
    imagefilledrectangle($banner, 10, 10, 390, 590, $black); // border
    imagefilledrectangle($banner, 20, 20, 380, 580, $white); // white background
    ...
    imagecopyresampled($banner, $logo, 100, 40, 0, 0, 200, 100, $logoWidth, $logoHeight);
    ...
    imagettftext($banner, 14, 0, 60, 450, $black, $fontPath, $message);
